...
gulp.task("copyAddonsScripts", function () {
  ...
  var aScript15 = gulp
    ...
    .pipe(gulp.dest("./vendors/flot"));
  var aScript16 = gulp
    .src(["node_modules/justgage/raphael-2.1.4.min.js"])
    .pipe(gulp.dest("./vendors/justgage"));
  var aScript17 = gulp
    .src(["node_modules/justgage/justgage.js"])
    .pipe(gulp.dest("./vendors/justgage"));
  var aScript18 = gulp
    .src(["node_modules/morris.js/morris.min.js"])
    .pipe(gulp.dest("./vendors/morris.js"));
  var aScript19 = gulp
    .src(["node_modules/raphael/raphael.min.js"])
    .pipe(gulp.dest("./vendors/raphael"));
  var aScript20 = gulp
    .src(["node_modules/jquery-tags-input/dist/jquery.tagsinput.min.js"])
  ...
  var aScript27 = gulp
    .src(["node_modules/dropify/dist/js/dropify.min.js"])
  ...
  var aScript48 = gulp
    .src(["node_modules/jquery-mapael/js/jquery.mapael.min.js"])
    .pipe(gulp.dest("./vendors/jquery-mapael"));
  var aScript49 = gulp
    .src(["node_modules/jquery-mapael/js/maps/france_departments.min.js"])
    .pipe(gulp.dest("./vendors/jquery-mapael"));
  var aScript50 = gulp
    .src(["node_modules/jquery-mapael/js/maps/world_countries.min.js"])
    .pipe(gulp.dest("./vendors/jquery-mapael"));
  var aScript51 = gulp
    .src(["node_modules/jquery-mapael/js/maps/usa_states.min.js"])
    .pipe(gulp.dest("./vendors/jquery-mapael"));
  var aScript52 = gulp
    .src(["node_modules/jvectormap/jquery-jvectormap.min.js"])
  ...
  var aScript57 = gulp
    ...
    .pipe(gulp.dest("./vendors/datatables.net-bs4"));
  var aScript58 = gulp
    .src(["node_modules/jsgrid/dist/jsgrid.min.js"])
  ...
  var aScript64 = gulp
    .src(["node_modules/jquery-toast-plugin/dist/jquery.toast.min.js"])
...
gulp.task("copyAddonsStyles", function () {
  ...
  var aStyle11 = gulp
    ...
    .pipe(gulp.dest("./vendors/fullcalendar"));
  var aStyle12 = gulp
    .src(["node_modules/c3/c3.min.css"])
    .pipe(gulp.dest("./vendors/c3"));
  var aStyle13 = gulp
    .src(["node_modules/chartist/dist/chartist.min.css"])
    .pipe(gulp.dest("./vendors/chartist"));
  var aStyle14 = gulp
    .src(["node_modules/morris.js/morris.css"])
    .pipe(gulp.dest("./vendors/morris.js"));
  var aStyle15 = gulp
    .src(["node_modules/jquery-tags-input/dist/jquery.tagsinput.min.css"])
    .pipe(gulp.dest("./vendors/jquery-tags-input"));
  var aStyle16 = gulp
  ...
  var aStyle26 = gulp
    ...
    .pipe(gulp.dest("./vendors/jquery-bar-rating"));
  var aStyle27 = gulp
    .src(["node_modules/dropify/dist/css/dropify.min.css"])
    .pipe(gulp.dest("./vendors/dropify"));
  var aStyle28 = gulp
  ...
  var aStyle40 = gulp
    ...
    .pipe(gulp.dest("./vendors/simplemde"));
  var aStyle41 = gulp
    .src(["node_modules/jvectormap/jquery-jvectormap.css"])
    .pipe(gulp.dest("./vendors/jvectormap"));
  var aStyle42 = gulp
    .src(["node_modules/datatables.net-bs4/css/dataTables.bootstrap4.css"])
    .pipe(gulp.dest("./vendors/datatables.net-bs4"));
  var aStyle43 = gulp
    .src(["node_modules/jsgrid/dist/jsgrid.min.css"])
    .pipe(gulp.dest("./vendors/jsgrid"));
  var aStyle44 = gulp
  ...
  var aStyle48 = gulp
    ...
    .pipe(gulp.dest("./vendors/dragula"));
  var aStyle49 = gulp
    .src(["node_modules/jquery-toast-plugin/dist/jquery.toast.min.css"])
    .pipe(gulp.dest("./vendors/jquery-toast-plugin"));
  var aStyle50 = gulp
...
gulp.task("copyMapFiles", function () {
  ...
  var map10 = gulp
    ...
    .pipe(gulp.dest("./vendors/quill"));
  var map11 = gulp
    .src("node_modules/chartist/dist/chartist.min.js.map")
    .pipe(gulp.dest("./vendors/chartist"));
  var map12 = gulp
    .src("node_modules/jquery-bar-rating/dist/jquery.barrating.min.js.map")
    .pipe(gulp.dest("./vendors/jquery-bar-rating"));
  var map13 = gulp
    .src("node_modules/lightgallery/src/css/lightgallery.css.map")
    .pipe(gulp.dest("./vendors/lightgallery/"));
  return merge(
    map1,
    map2,
